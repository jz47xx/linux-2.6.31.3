...
static void dump_icdc_regs(struct snd_soc_codec *codec,
...
static void dump_aic_regs(const char *func, int line)
{
...
static int jz_icdc_pcm_prepare(struct snd_pcm_substream *substream,
			       struct snd_soc_dai *dai)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_device *socdev = rtd->socdev;
...
#if 0
	/* clr SB_SLEEP */
	jz_icdc_update_reg(codec, JZ_ICDC_PMR1,
...
static const struct snd_soc_dapm_route intercon[] = {
	...
	{ "LHPOUT", "HP Out", "Left Out Mux" },
	{ "RHPOUT", "HP Out", "Right Out Mux" },

	{ "LOUT", "Line out", "LHPOUT" },
	{ "ROUT", "Line out", "RHPOUT" },
