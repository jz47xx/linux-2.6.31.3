	...
	struct snd_pcm_hw_params *params)
{
	...
	ret = snd_soc_dai_set_sysclk(codec_dai, 0, JZ4770_I2S_SYSCLK,
				     SND_SOC_CLOCK_IN);
	if (ret < 0)
		return ret;
	...
	ret = cpu_dai->ops->set_sysclk(cpu_dai, JZ4770_I2S_SYSCLK, 0,
		SND_SOC_CLOCK_IN);
	if (ret < 0)
		return ret;
#endif
...
static struct snd_soc_card snd_soc_card_pisces = {
	...
	.dai_link = &pisces_dai,
	.platform = &jz4770_soc_platform,/* defined in sound/soc/jz4770/jz4770-pcm.c */
