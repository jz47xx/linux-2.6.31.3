						     ...
						     void *data, int silent)
{
	...
	if (yaffsVersion == 2) {
...
#endif
		tempBlocks = mtd->size;
		do_div(tempBlocks, mtd->erasesize);
		nBlocks = tempBlocks;
		...
		T(YAFFS_TRACE_OS, (" nChunksPerBlock:%d\n", dev->nChunksPerBlock));
		T(YAFFS_TRACE_OS, (" nDataBytesPerChunk:%d\n", dev->nDataBytesPerChunk));
		T(YAFFS_TRACE_OS, (" nBlocks:%d\n", nBlocks));
		T(YAFFS_TRACE_OS, (" endBlock:%d\n", dev->endBlock));
		T(YAFFS_TRACE_OS, (" nCheckpointReservedBlocks:%d\n", dev->nCheckpointReservedBlocks));
